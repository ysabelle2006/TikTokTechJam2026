...
RESULT_PATH = Path(
    "results/v2_spatial_augmented_robustness.txt"
)
...
def main():
    ...
    # ========================================================
    # Load V2 augmented spatial classifier
    # ========================================================

    print(
        "Loading V2 augmented spatial classifier..."
    )

    classifier = SpatialHead().to(
        device
    )
